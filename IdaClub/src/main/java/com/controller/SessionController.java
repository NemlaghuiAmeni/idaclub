...
public class SessionController {
	...
	public ResponseEntity<Response> SaveSessionServer(@RequestParam("files") MultipartFile file,
		...
		String modifierfilename = ss.getId() + "." +"jpg";
	...
	@RequestMapping(value = "sess/type/{type}", method = RequestMethod.GET)
	public List<Session> gettypeSession( @PathVariable String type) {
		LOG.info("Getting all Session.");
		return SessionS.getBytype(type);
	}
	/*@RequestMapping(value = "/sess/langue", method = RequestMethod.GET)
	public List<Session> gettypeSessionlangue(  String type) {
		LOG.info("Getting all Session.");
		return SessionS.getBytypelangue(type);
	}*/
...
// cree une session avec methode POST
	...
	@PostMapping("/sess/{id}/Interessee")
	public ResponseEntity<Void> ajoutinteresseeSession(@PathVariable int id, @RequestBody Interessee inter) {

		SessionS.addInterToSession(id, inter);
	...
	//add RESERVEE to session
		@PostMapping("/sessionRes/{id}/Reserve")
		public ResponseEntity<Void> ajoutResSession(@PathVariable int id, @RequestBody Reservee res) {

			SessionS.addResToSession(id,res );
